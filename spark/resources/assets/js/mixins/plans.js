...
module.exports = {
    data() {
        return {
            ...
            planSelectedOptionData : null,
            planSelectedOptionValue : 'all',

        };
    },

    mounted() {
        this.planSelectedOptionData = this.paidPlansForActiveInterval_();
        console.log(_this.planSelectedOptionData)
    },
    ...
    methods: {
        ...
        SelectPlan(){
            let _this = this;
            let value = _this.planSelectedOptionValue;
            if(value !== 'all'){
                _this.planSelectedOptionData = [_this.plansForActiveInterval[value-1]]
            } else {
                _this.planSelectedOptionData = _this.plansForActiveInterval
            }
        },
