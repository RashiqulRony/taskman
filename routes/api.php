...
//List section
Route::get('/list/{id}', 'MultipleListController@GetList'); //get single list
...
Route::post('/single-task', 'TaskController@getSingleTask'); //get task single

//task list tags related
Route::get('/task-list/all-tag-for-manage', 'TagsController@index'); //get all tag
Route::post('/search-tag', 'SearchController@tagSearch'); //search tag
...
Route::post('/nav-item/delete', 'ProjectNavItemsController@Delete'); //all nav item
...
Route::post('/all-board-card', 'MultipleBoardController@GetAllBoardCard'); //get board item
...
Route::post('/board-card/copy-cut-past', 'MultipleBoardController@CopyCutPast');
Route::post('/board-card/move-up-down', 'MultipleBoardController@cardMoveUpDown');
...
Route::post('/board-hide/{id}', 'MultipleBoardController@hideColumn');//hide column
...
Route::post('/get-all-comment-count', 'CommentController@getCommentCount');
Route::post('/get-all-unseen-comment-count', 'CommentController@getUnseenCommentCount');
...
Route::get('/overview-all-lists/{project_id}', 'OverviewController@GetAllList');
...
Route::post('/project-assign-check', 'OverviewController@projectAssignCheck');
// overview team member action
Route::post('/overview-team-member-add', 'OverviewController@AddTeamMember');
Route::post('/overview-team-member-remove', 'OverviewController@RemoveTeamUser');
...
Route::post('/project-users', 'HomeController@teamUser');
Route::post('/all-project-users', 'ProjectUserController@AllUser');
...
Route::get('/get-priority-task', 'ProfileController@monthlyPriorityTask');

//Comments where user is assigned to
Route::get('/get-comments-for-user', 'ProfileController@commentsForUser');


// Import CSV
Route::post('/task-import-csv', 'ImportTaskController@importCsv');
Route::post('/task-import-csv-save', 'ImportTaskController@importCsvSave');
