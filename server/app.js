...
io.on('connection', function(socket) {
    ...
    socket.on('UpdateNav',function (data) {
        io.emit('UpdateNav'+data.project_id,data);
        console.log('UpdateNav'+data.project_id);
    })

    socket.on('DeleteNav',function (data) {
        io.emit('DeleteNav'+data.project_id,data);
        console.log('DeleteNav'+data.project_id);
    })

    socket.on('updateTask-overview',function (data) {
        io.emit('updateTask-overview',data);
    })
});
