    ...
    <div class="align-self-center" @click="HideDetails">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button @click="AddNewList" class="btn save-all mr-3" type="button">Create List</button>
        ...
        <div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="addBoardModel" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title pl-3"> Add Board</h5>
                        <button aria-label="Close" class="close" data-dismiss="modal" type="button">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button aria-label="Close" class="btn btn-secondary ml-2" data-dismiss="modal" type="button">Cancel
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="addNavItem" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button @click="AddNavItem" class="btn save-all" type="button">Add</button>
                        <button aria-label="Close" class="btn btn-secondary ml-2" data-dismiss="modal" type="button">Cancel
                        </button>
                    </div>
                </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button aria-label="Close" class="btn btn-secondary ml-1" data-dismiss="modal" type="button">Cancel
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="addListFromOverviewModel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button @click="AddNewListOverview" class="btn save-all mr-1" type="button">Add</button>
                        <button aria-label="Close" class="btn btn-secondary ml-2" data-dismiss="modal" type="button">Cancel
                        </button>
                    </div>
                </div>
