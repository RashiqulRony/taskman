                    ...
                    <form @submit.prevent="updateProfile">
                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                <label for="full_name" class="col-sm-3 col-form-label font-weight-bold">Name</label>
                                <div class="col-sm-9">
                                    <input
                                        type="text"
                                        class="form-control"
                            ...
                            <div class="form-group row">
                                <label for="phone" class="col-sm-3 col-form-label font-weight-bold">Phone</label>
                                <div class="col-sm-9">
                                    <input
                                        type="text"
                                        class="form-control"
                ...
                <div class="modal-content">
                    ...
                    <form @submit.prevent="updateCardInfo">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group row">
                                <label for="card_last_four" class="col-sm-2 col-form-label font-weight-bold">Card Last 4 Digit</label>
                                <div class="col-sm-10">
                                    <input
                                        type="text"
                                        class="form-control"
                            ...
                            <div class="form-group row">
                                <label
                                    for="card_country"
                                    class="col-sm-2 col-form-label font-weight-bold">Card Country</label>
                                <div class="col-sm-10">
                                    <input
                                        type="text"
                                        class="form-control"
