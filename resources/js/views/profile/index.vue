                                        ...
                                        <div class="col-8">
                                            <div class="card">
                                                <div class="card-header bg-secondary text-white">
                                                    ...
                                                    <a class="float-right profile-edit"
                                                       data-toggle="modal"
                                                       data-target="#personal_info"
                                                       @click="getProfile">

                                                        <i class="fal fa-edit" aria-hidden="true" data-toggle="tooltip" :data-original-title="profileUpdatedAt(profile.updated_at)"></i>
                                                    </a>
                                                </div>
                                                <div class="card-body">
                                                    <div class="row ml-2">
                                            ...
                                            <div class="card">
                                                <div class="card-header bg-secondary text-white">
                                                    <span data-toggle="collapse" data-target="#billingInfoSection" aria-expanded="true" aria-controls="billingInfoSection">
                                                        <i class="fad fa-chevron-double-down"></i> Billing Information
                                                    </span>

                                                    <a class="float-right profile-edit" data-toggle="modal" data-target="#billing_info" @click="getBillingInfo">
                                                        <i class="fal fa-edit" aria-hidden="true" data-toggle="tooltip" :data-original-title="profileUpdatedAt(profile.updated_at)"></i>
                                                    </a>
                                                </div>
...
<script>
    ...
    export default {
        components: {
            editModal: edit, dueTaskPanel: taskPanel, commentPanel: commentPanel
        },
        data() {
            return {
                profile: {},
        ...
        methods: {
            profileUpdatedAt(value) {
                return (
                    "Profile Updated " + moment.utc(value).local().locale("en-short").fromNow()
                );
            },
            getUser() {
                let _this = this;
            ...
            getBillingInfo() {
                let _this = this;
                $('#billingInfoSection').addClass('show');

                axios.get("/api/get-billing-info")
                    .then(response => response.data)
                    .then(response => {
