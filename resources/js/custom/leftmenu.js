...
$(document).on('click', '.panel-heading .clickable', function(e) {
    ...
    if (!$this.hasClass('panel-collapsed')) {
        ...
        $this.addClass('panel-collapsed').removeClass('fa-angle-up').addClass('fa-angle-down');
        $('.showhide').attr('title', 'Show Panel content');
    } else {
        $this.parents('.panel').find('.panel-body').slideDown();
        $this.removeClass('panel-collapsed').removeClass('fa-angle-down').addClass('fa-angle-up');
        $('.showhide').attr('title', 'Hide Panel content');
    }
});
//leftmenu init
