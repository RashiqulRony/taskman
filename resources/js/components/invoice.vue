                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-condensed" id="customtable">
                            ...
                            <tr class="bg-primary">
                                ...
                                <th class="text-center" id="add_row"><i class="fa fa-fw fa-plus"  @click="addRow"></i></th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr v-for="(input, index) in tr">
                                ...
                                <td class="text-center row_delete"><i class="fa fa-fw fa-times" @click="removeRow(index)"></i></td>
                            </tr>
                            </tbody>
                            <tfoot>
                            <tr>
                    ...
                    <div class="col-md-12 col-sm-12 col-12">
                                <span class="float-right">
                                            <button type="button"
                                                    ...
                                                    data-toggle="button">
                                                <i class="fa fa-fw fa-dollar-sign"></i> Pay Now
                                            </button>
                                             <button type="button"
