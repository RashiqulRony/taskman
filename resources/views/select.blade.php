    ...
    <div class="col-md-6 mx-auto">
        <div class="card border-primary">
            <div class="card-header bg-primary text-white">
                <h3 class="card-title">
                                <i class="fa fa-fw fa-arrow-square-down"></i> Select2
                            </h3>
            </div>
            <div class="card-body">
                <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="input-group-append">
                                        ...
                                        <div class="input-group-append">
                                            <label class="input-group-text" for="select24"> <span class="fa-search"></span></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group-prepend">
                                        <div class="input-group-prepend" data-select2-open="select25">
                                            <label class="input-group-text" for="inputGroupSelect01"><span class="fa-search"></span></label>
                                        </div>
