                ...
                <table class="table table-valign-middle mb-0">
                    ...
                    <tbody>
                        <tr v-for="member in team.users">
                            ...
                            <td class="td-fit">
                                <button class="btn btn-primary" @click="editTeamMember(member)" v-if="roles.length > 1 && canEditTeamMember(member)">
                                    <i class="fa fa-cog"></i>
                                </button>

                                <button class="btn btn-danger" @click="approveTeamMemberDelete(member)" v-if="canDeleteTeamMember(member)">
