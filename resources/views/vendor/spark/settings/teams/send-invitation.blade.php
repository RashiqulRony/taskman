<spark-send-invitation :user="user" :team="team" :billable-type="billableType" default-role="{{Spark::defaultRole()}}" inline-template>
    <div class="card card-default border-primary">
        <div class="card-header bg-primary text-white">{{__('Send Invitation')}}</div>
        ...
        <div class="card-body">
            ...
            <form role="form" v-if="canInviteMoreTeamMembers && remainingTeamMembers > 0">
                <!-- E-Mail Address -->
                ...
                <div class="form-group row mb-0">
                    <div class="offset-md-4 col-md-6">
                        ...
                        <a href="#/subscription" class="btn btn-info float-right">Update Subscription</a>
                    </div>
                </div>
            </form>
            ...
            <div v-else>
                <span class="text-danger">
                    ...
                    <!-- Subscription Button to buy plan -->
                    <a href="#/subscription" class="btn btn-primary float-right">Update Subscription</a>
                </span>
            </div>
