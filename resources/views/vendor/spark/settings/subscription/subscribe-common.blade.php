<div class="card card-default">
    <div class="card-header bg-primary text-white">
        ...
        <div class="row">
            <div style="padding: 2px 15px 0px 85px">
                How many team members do you want total?
            </div>
            <div class="mr-2">
                <select class="js-example-disabled-results form-control" v-model="planSelectedOptionValue"
                        v-on:change="SelectPlan()">
                    <option value="all">All</option>
                    <template v-for="i in parseInt(30)">
                        <option v-if="i>1" :value="i">@{{i}}</option>
                    </template>
                </select>
            </div>
        </div>
    ...
    <!-- Plan Error Message -->
        ...
        <table class="table table-responsive-sm table-valign-middle mb-0 ">
            <tbody>
            <tr v-for="plan in planSelectedOptionData">
                <!-- Plan Name -->
                <td>
