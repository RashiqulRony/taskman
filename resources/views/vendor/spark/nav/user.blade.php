    ...
    <nav class="navbar navbar-light navbar-expand-md navbar-spark" style="padding: 0;">
        <div class="container-fluid" v-if="user" style="padding-left: 0;">
            ...
            <div id="navbarSupportedContent" class="collapse navbar-collapse show">
                ...
                <a @click="showNotifications('notification')" class="mb-3 mb-md-0 mr-md-0 ml-md-auto float-sm-left mt-2">
                    <i class="fa fa-fw fa-bell-o" style="font-size:17px;"></i>
                    <span class="badge badge-pill" style="background-color:#174991;">@{{notificationsCount}}</span>
                </a>
                <a @click="showNotifications('comment')" class="mb-3 mb-md-0 mr-md-0 ml-2 float-sm-left mt-2">
                    <i class="fa fa-fw fa-comment-o" style="font-size:17px;"></i>
                    <span class="badge badge-pill" style="background-color:#174991;" v-if="totalCommentCount > 99">99+</span>
                    <span class="badge badge-pill" style="background-color:#174991;" v-else>@{{totalCommentCount}}</span>
                </a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        @if (Spark::usesTeams() && (Spark::createsAdditionalTeams() || Spark::showsTeamSwitcher()))
                            ...
                            <a href="/logout" class="dropdown-item">
                                Logout <i class="fa fa-fw fa-sign-out" title="Log out"></i>
                            </a>
                        </div>
                    </li>
                </ul>
