...
<main class="main-content">
    ...
    <div class="bg-white rounded shadow-7 w-400 mw-100 p-6" style="text-align: center;">
        <img src="{{asset('img/color-logo.png')}}" alt="" class="img-responsive" style="max-width: 215px;margin-bottom: 15px">
