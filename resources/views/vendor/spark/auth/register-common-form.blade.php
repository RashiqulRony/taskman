<form role="form">
    ...
    <div v-if=" ! selectedPlan || selectedPlan.price == 0">
        ...
        <div class="form-group row mb-0">
            <div class="col-md-12">
                <button class="btn btn-primary btn-block" @click.prevent="register" :disabled="registerForm.busy" onclick="gtag('event', 'click', { 'send_to': 'UA-156350210-3', 'event_category': 'register', 'event_action': 'click', 'event_label': 'signup'});">
